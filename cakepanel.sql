...
INSERT INTO `cms_accounts` VALUES (1,1,1,'admin','admin@yahoo.com','1d77e03c6e6da258ed15229d957001d56298169e','2017-11-20 14:08:22','2013-01-04 00:00:00',1,'2017-08-04 10:37:59',1);
...
CREATE TABLE `cms_entry_metas` (
  ...
  `value` text NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3482 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-11-20 14:12:35
