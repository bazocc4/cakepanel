...
(function($){
    ...
    $.fn.burgerMenu = function(options) {
        ...
        function createButton(eq){
            ...
            var $button = $('<div class="burger-menu-button burger-menu-button-' + eq + ' burger-menu-theme-'+settings.themeColor+'"></div>'),
            buttonCss = {
        ...
        function createMenuLink($a, eq, len){
            ...
            var $link = $('<a>').attr('href', $a.attr('href')).attr('class', $a.attr('class') ).text(settings.linkText($a)),
            linkCss = {
        ...
        function getMenuWidth(){
            ...
            var newMenuWidth = settings.menuWidth;
            ...
            if(settings.keepButtonNextToMenu){
                ...
                if(settings.menuWidth.indexOf('%') > -1){
                    ...
                    return ((($(window).width() * (parseInt(newMenuWidth) / 100))) - parseInt(settings.buttonWidth)) + 'px';
        ...
        return this.each(function(eq){
            ...
            ensureVisibleOnlyInBreakpoint = function(w){
                ...
                // untuk burger menu muncul terus
