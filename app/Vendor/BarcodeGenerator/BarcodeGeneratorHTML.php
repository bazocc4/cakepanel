    ...
    public function getBarcode($code, $type, $widthFactor = 2, $totalHeight = 30, $color = 'black')
    {
        ...
        foreach ($barcodeData['bars'] as $bar) {
            ...
            if ($bar['drawBar']) {
                ...
                // draw a vertical bar
                $html .= '<div style="background-color:' . $color . ';width:' . $barWidth . 'px;height:' . $barHeight . 'px;display:inline-block;margin-left:' . $prevBarWidth . 'px;top:' . $positionVertical . 'px;">&nbsp;</div>' . "\n";
            }
